          ...
          <a-form :form="form" v-bind="formLayout">
            ...
            <a-form-item label="课程多图">
              ...
              <a-upload
                ...
                v-decorator="['multigraph', {rules: [{required: false, message: '请上传课程多图'}]}]"
                accept="image/*"
            ...
            <a-form-item label="课程次数">
              <a-input-number
                ...
                :min="1"
                :step="1"
                v-decorator="['course_num', {rules: [{required: true, message: '请输入课程次数'}]}]"
                placeholder="请输入课程次数" />
            </a-form-item>
            <a-form-item label="课程有效期">
              <a-input-number
                ...
                :min="1"
                :step="1"
                v-decorator="['period_validity_num', {rules: [{required: true, message: '请输入课程有效期'}]}]"
            ...
            <a-form-item label="单次时长(分钟)">
              <a-input-number
                ...
                :min="1"
                :step="1"
                v-decorator="['single_duration', {rules: [{required: true, message: '请输入单次时长'}]}]"
                placeholder="请输入单次时长" />
            </a-form-item>
