    ...
    <div class="drawer-wrap">
      <div class="drawer-body">
        <a-spin :spinning="loading">
          ...
          <div style="width: 100%;box-sizing: border-box;padding-bottom: 24px" v-else>
          ...
          <div
            style="width: 100%;padding-top: 24px;box-shadow: rgba(0, 0, 0, 0.45) 0 -15px 20px -20px;"
            v-if="model.status === 2">
      ...
      <div class="drawer-footer">
        ...
        <a-button type="primary" @click="handleConfirm" :loading="loading" v-if="model.status === 2">确定
        </a-button>
      </div>
    </div>
