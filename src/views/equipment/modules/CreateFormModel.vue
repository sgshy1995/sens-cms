        ...
        <a-spin :spinning="loading">
          <a-form :form="form" v-bind="formLayout">
            ...
            <a-form-item label="品牌">
              <a-input
                v-decorator="['brand', {rules: [{required: true, min: 1, max: 20, message: '请输入至少1字符，最多20个字符'}]}]"
                placeholder="请输入品牌" />
            </a-form-item>
            ...
            <a-form-item label="发货地">
              <a-select
                v-decorator="['dispatch_place', {rules: [{required: true, trigger: 'change', message: '请选择发货地'}]}]"
                placeholder="请选择">
            ...
            <a-form-item label="型号多图">
              ...
              <a-upload
                ...
                v-decorator="['multi_figure', {rules: [{required: true, message: '请上传型号多图'}]}]"
                accept="image/*"
            ...
            <a-form-item label="是否发布">
              <a-select
                v-decorator="['status', {rules: [{required: true, trigger: 'change', message: '请选择是否发布'}]}]"
                placeholder="请选择">
