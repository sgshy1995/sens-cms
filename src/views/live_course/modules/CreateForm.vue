    ...
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="直播次数">
          <a-input-number style="width: 100%" :precision="0" :min="1" :step="1" v-decorator="['live_num', {rules: [{required: true, message: '请输入直播次数'}]}]" placeholder="请输入直播次数" />
        </a-form-item>
...
// 表单字段
const fields = ['id', 'title', 'cover', 'description', 'course_type', 'live_num', 'price', 'is_discount', 'discount', 'discount_validity', 'carousel', 'status']
