  ...
  >
    <div class="drawer-wrap">
      ...
      <div class="drawer-footer">
        <a-button @click="backward" v-if="currentStep > 0" style="float: left">上一步</a-button>
        <a-button @click="handleCancel">取消</a-button>
        <a-button type="primary" :loading="confirmLoading" @click="handleNext(currentStep)">{{ currentStep === 2 && '完成' || '下一步' }}</a-button>
      </div>
    </div>
