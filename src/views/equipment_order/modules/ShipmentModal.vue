              ...
              <div class="shipment-modal-body-in">
                <a-form :form="form" v-bind="formLayout">
                  <a-form-item label="物流单号">
                    <a-input
                      v-decorator="['courier_number', {rules: [{required: true, min: 1, message: '请输入物流单号'}]}]"
                      placeholder="请输入物流单号" />
                  </a-form-item>
                  <a-form-item label="物流公司">
                    <a-select
                      ...
                      showSearch
                      v-decorator="['courier_company', {rules: [{required: true, trigger: 'change', message: '请选择物流公司'}]}]"
                      placeholder="请选择物流公司">
                  ...
                  <a-form-item label="起送联系人">
                    <a-input
                      v-decorator="['origin_name', {rules: [{required: true, min: 1, message: '请输入起送联系人'}]}]"
                      placeholder="请输入起送联系人" />
                  </a-form-item>
                  <a-form-item label="起送联系电话">
                    <a-input
                      v-decorator="['origin_phone', {rules: [{required: true, min: 1, message: '请输入起送联系电话'}]}]"
                      placeholder="请输入起送联系电话" />
                  </a-form-item>
                  <a-form-item label="起送地址">
                    <a-input
                      v-decorator="['origin_address', {rules: [{required: true, min: 1, message: '请输入起送地址'}]}]"
                      placeholder="请输入起送地址" />
                  </a-form-item>
